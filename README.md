...
|23.6.|1|62|Change current energy to current max power|TODO: 1 GET weekly, 2 GET monthly. 4 Aggregated energy generation in plant image. 6 Tooltips to barchar to indicate values when individual bar is pressed. 7 Authentication|
